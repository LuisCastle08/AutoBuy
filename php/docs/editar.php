        ...
        ?>
                ...
                <tbody>
                  ...
                  <td><?php echo $modelo; ?></td>
                    <td><?php echo $kilometros; ?></td>
                    <td><?php echo $ciudad; ?></td>
                    <td><?php echo $tipodepago; ?></td>
                    <td><?php echo $precio; ?></td>
                    <td><?php echo substr($descripcion, 0, 20)."...";?></td>
                    ...
                    <td><a class="btn btn-primary" href="editarex.php?id=<?php echo $id?>"><i class="fa fa-lg fa-edit"></i></a></td>
                  </tr>
