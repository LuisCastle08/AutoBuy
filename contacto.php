		...
		<div class="container">
			<div class="flex-w flex-tr">
				<div class="size-210 bor10 p-lr-70 p-t-55 p-b-70 p-lr-15-lg w-full-md">
						...
						<h4 class="mtext-105 cl6 txt-center p-b-30">
							Envianos un mensaje por Whatsapp
						</h4>
						

						<a href="https://api.whatsapp.com/send?phone=+529931383926&amp;"><button class="flex-c-m stext-101 cl0 size-121 bg3 bor1 hov-btn3 p-lr-15 trans-04 pointer">
							Contactar! 
						</button></a>
			...
			<div class="row">
				...
				<div class="col-sm-6 col-lg-3 p-b-50">
					...
					<p class="stext-107 cl7 size-201">
						Alguna duda? Estamos atentos a su llamada al telefono celular (+55) 556321788
					</p>
				</div>
